...
public class Login extends javax.swing.JFrame  {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(signbtn, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 101, Short.MAX_VALUE))))
    ...
    private void LoginBtnMouseClicked(java.awt.event.MouseEvent evt) {                                      
        ...
        {     JOptionPane.showMessageDialog(this, "Missing_info,please fill your credentials");
       // new Login().setVisible(true);
        }
        
        else{String valid=Client.loginCS(role, uname, pass);
        switch(valid){
            case "notvalid":
            ...
            case "validClient":
                ...
                new options(uname).setVisible(true);
                this.dispose();
                break;
            case "Avalid":
                //JOptionPane.showMessageDialog(this, "valid UserNameAdmin or PasswordAdmin");
                new Product().setVisible(true);
                this.dispose();
                break;
            case "notinA":
                JOptionPane.showMessageDialog(this, "Wrong Admin_name or Admin_Pass");
                break;
    ...
    private void signbtnMouseClicked(java.awt.event.MouseEvent evt) {                                     
